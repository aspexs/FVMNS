...
extern double mass;
ArgonSolver::ArgonSolver(QObject *parent): AbstaractSolver(parent)
{

}

void ArgonSolver::solve()
{
    prepareSolving();
...
void ArgonSolver::prepareSolving()
{
...
void ArgonSolver::solveFlux(Matrix U1L, Matrix U2L, Matrix U3L, Matrix U1R, Matrix U2R, Matrix U3R)
{
    left_density   = U1L;
    right_density  = U1R;
...
void ArgonSolver::calcRiemanPStar()
{
